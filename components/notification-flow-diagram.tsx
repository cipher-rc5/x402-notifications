    ...
    <div className='relative py-16 px-4'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='relative flex items-start justify-between gap-8'>
          ...
          <div className='flex flex-col items-center text-center space-y-4 flex-1 relative z-10'>
            <div className='relative'>
              <div className='absolute inset-0 bg-[#03E1FF]/20 rounded-full blur-xl animate-pulse' style={{ animationDelay: '0.5s' }} />
              <div className='relative rounded-full w-20 h-20 bg-background border-2 border-[#03E1FF]/60 flex items-center justify-center shadow-lg'>
                <svg className='h-10 w-10 text-[#03E1FF]' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
          ...
          <div className='flex flex-col items-center text-center space-y-4 flex-1 relative z-10'>
            <div className='relative'>
              <div className='absolute inset-0 bg-[#03E1FF]/20 rounded-full blur-xl animate-pulse' style={{ animationDelay: '1s' }} />
              <div className='relative rounded-full w-20 h-20 bg-background border-2 border-[#03E1FF]/60 flex items-center justify-center shadow-lg'>
                <svg className='h-10 w-10 text-[#03E1FF]' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
          ...
          <div className='flex flex-col items-center text-center space-y-4 flex-1 relative z-10'>
            <div className='relative'>
              <div className='absolute inset-0 bg-[#03E1FF]/20 rounded-full blur-xl animate-pulse' style={{ animationDelay: '1.5s' }} />
              <div className='relative rounded-full w-20 h-20 bg-background border-2 border-[#03E1FF]/60 flex items-center justify-center shadow-lg'>
                <svg className='h-10 w-10 text-[#03E1FF]' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                  <path
                    strokeLinecap='round'
