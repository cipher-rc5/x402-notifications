        ...
        <Card className='p-6 border-primary/20 bg-primary/5'>
          <div className='space-y-3'>
            ...
            <p className='text-sm text-muted-foreground text-pretty'>
              This system supports Model Context Protocol. AI assistants can interface with notifications, payments, and user data via the
              {' '}
              <code className='px-1 py-0.5 rounded bg-muted'>/api/mcp</code> endpoint.
            </p>
