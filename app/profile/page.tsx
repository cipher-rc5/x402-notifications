      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        {!sessionToken ? (
          <Card className="p-6 space-y-6 bg-slate-900/40 backdrop-blur-md border-slate-800/50 shadow-lg">
            <Alert className="bg-yellow-500/10 border-yellow-500/20">
              ...
              <AlertDescription className="ml-2 text-muted-foreground">
                <strong className="text-yellow-500">Complete your first x402 payment</strong> to unlock your custom MCP
                endpoint for AI assistant integration.
              </AlertDescription>
            </Alert>
              ...
              <Tabs value={selectedNetwork} onValueChange={(v) => setSelectedNetwork(v as typeof selectedNetwork)}>
                ...
                <TabsContent value="base-sepolia" className="space-y-4 mt-4">
                  <div className="space-y-2">
                    <Label htmlFor="base-address" className="text-muted-foreground">
                ...
                <TabsContent value="solana-devnet" className="space-y-4 mt-4">
                  <div className="space-y-2">
                    <Label htmlFor="solana-address" className="text-muted-foreground">
          ...
          <Alert className="bg-green-500/10 border-green-500/20">
            ...
            <AlertDescription className="ml-2 text-muted-foreground">
              <strong className="text-green-500">Payment verified!</strong> Your MCP endpoint is active and ready to
              use.
            </AlertDescription>
          </Alert>
        )}
        ...
        {sessionToken && (
          <>
            ...
            <Card className="p-6 space-y-4 bg-slate-900/40 backdrop-blur-md border-slate-800/50 shadow-lg">
              ...
              <Button
                variant="outline"
                className="w-full bg-transparent border-slate-700 text-slate-200 hover:bg-slate-800"
                asChild
              >
