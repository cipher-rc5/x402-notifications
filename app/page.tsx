...
import { Bell, Zap, Shield, Wallet, Code2, Globe } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/10">
      <div className="container mx-auto px-6 py-16 max-w-6xl">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-balance bg-gradient-to-r from-foreground via-foreground to-foreground/60 bg-clip-text text-transparent">
        ...
        {/* CTA Section */}
        <Card className="p-8 md:p-12 border-primary/20 bg-gradient-to-r from-primary/5 to-primary/10 text-center">
