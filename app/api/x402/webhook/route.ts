...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      sessionToken,
      mcpEndpoint: `${process.env.NEXT_PUBLIC_APP_URL || "https://your-domain.com"}/api/mcp`,
